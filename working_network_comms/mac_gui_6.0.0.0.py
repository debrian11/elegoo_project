...
# mouse press/release on on-screen arrow buttons
arrow_up.bind("<ButtonPress-1>", f_button)
arrow_up.bind("<ButtonRelease-1>", s_button)

arrow_left.bind("<ButtonPress-1>", l_button)
arrow_left.bind("<ButtonRelease-1>", s_button)

arrow_down.bind("<ButtonPress-1>", b_button)
arrow_down.bind("<ButtonRelease-1>", s_button)

arrow_right.bind("<ButtonPress-1>", r_button)
arrow_right.bind("<ButtonRelease-1>", s_button)

# key bindings (use KeyPress/KeyRelease for clarity)
control_gui.bind("<KeyPress-Up>", f_button)
control_gui.bind("<KeyRelease-Up>", s_button)
control_gui.bind("f", f_button)

control_gui.bind("<KeyPress-Left>", l_button)
control_gui.bind("<KeyRelease-Left>", s_button)
control_gui.bind("l", l_button)

control_gui.bind("<KeyPress-Down>", b_button)
control_gui.bind("<KeyRelease-Down>", s_button)
control_gui.bind("b", b_button)

control_gui.bind("<KeyPress-Right>", r_button)
control_gui.bind("<KeyRelease-Right>", s_button)
control_gui.bind("r", r_button)

control_gui.bind("s", s_button)
