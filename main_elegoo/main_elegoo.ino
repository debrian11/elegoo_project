...
// Read input from Ardui
// Take input over serial on which servo to move and light up the respective LED for which servo
// if the distance is between certain value, move servo 
// have 3 pot_states:
// - 1 = left servo || 2 = right servo ||3 stby
